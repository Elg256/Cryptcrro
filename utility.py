...
def add_encrypt_tags_rsa(encrypted_symetric_key:int, encrypted_message):
    #encrypted_symetric_key_bytes = encrypted_symetric_key.to_bytes(encrypted_symetric_key.bit_length()//8, byteorder="big")

    #encrypted_symetric_key_str = str(encrypted_symetric_key)

    #encrypted_symetric_key = base64.urlsafe_b64encode(encrypted_symetric_key_str.encode()).decode('utf-8')
